...
public class CheckItem {
    public static boolean isMeDay(short id) {
        return id >= 4587 && id <= 4590;
    }
    public static boolean isWing(short id) {
        return id >= 2880 && id <= 2935;
    }
    public static boolean isTinhTu(short id) {
    ...
    public static boolean item4CanTrade(short id) {
        List<Short> cantrade = new ArrayList<>(java.util.Arrays.asList((short) 101, (short) 205, (short) 206, (short) 207, (short) 224, (short) 249, (short) 273, (short) 274));
         List<Short> cantrade1 = new ArrayList<>(java.util.Arrays.asList((short)135, (short)52, (short)56, (short)143, (short)226, (short)241,(short) 25, 
                 (short)5, (short)6, (short)7, (short)10, (short)13, (short)26,
                                    (short)16, (short)24, (short)69, (short)164, (short)166, (short)168, (short)170, (short)70, (short)71,(short) 72, (short)73, (short)74,
                                    (short)125, (short)223, (short)247,(short) 269, (short)57, (short)58, (short)59, (short)219,(short)48,(short)49,(short)50,(short)51));
        ...
        boolean vpsk = (id >= 28 && id <= 47) || (id >= 89 && id <= 130 && id != 124 && id != 125) || (id >= 137 && id <= 145 && id != 142 && id != 143) || (id >= 148 && id <= 158) || id == 162
                || id == 172 || (id >= 183 && id <= 195) || (id >= 199 && id <= 204) || (id >= 254 && id <= 258) || (id >= 303 && id <= 308);
        return sknoel || vpsk || cantrade.contains(id)|| cantrade1.contains(id);
    }
